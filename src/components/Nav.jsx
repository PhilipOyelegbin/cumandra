...
const Nav = () => {
  ...
  return (
    <nav className="flex justify-between items-center text-slate-200 p-5 md:px-20 md:py-5 z-30">
      ...
      <ul className={`fixed bg-[#240556] gap-5 w-full pl-5 py-4 top-12 transition-all ease-in-out duration-300 md:flex md:items-center md:static md:w-auto md-pl-0 md:py-0 z-30 ${show ? 'right-0' : '-right-full'}`}>
